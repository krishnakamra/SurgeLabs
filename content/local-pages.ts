...
export const localPages: readonly LocalPage[] = [
  ...
  },
  {
    ...
    city: "etobicoke",
    intro: [
      "Etobicoke is the closest thing we have to a home market after Mississauga itself. We are at Skymark Ave, a few minutes off the 427, which means most of Etobicoke is a ten to fifteen minute drive and same-day pickup is genuinely same-day rather than a technicality. That proximity changes what is worth ordering: if you want to see a proof on the actual stock before committing to two thousand cards, you can, and people here do.",
      "The work splits along the old municipal lines. The professional practices around Islington-City Centre West and the Kingsway order the way established firms order — 16pt coated with soft-touch, often with spot UV on the mark, and a growing amount of foil since the towers went up. Those cards are handed over in meetings where someone is deciding whether to trust a firm with money or a house sale, and the substrate does quiet work in that moment.",
      "Along The Queensway and through the older main streets in Mimico, New Toronto and Long Branch, it is a different order entirely. Trades, auto, restaurants, independent retail. Those go on 18pt uncoated because they get written on — a price, a time, a part number — and a coated card refuses a pen. The priority is a phone number legible at arm's length in bad light, not a finish.",
      "Rexdale and the industrial blocks near the airport are the third pattern: high volume, low finish, reordered on a schedule. Frequently the same file three times a year with a different name on it. We keep those set up so a reorder is an email rather than a briefing, and we will not upsell a soft-touch laminate onto a card that lives in a glovebox.",
    ],
    neighbourhoods: ["Islington-City Centre West", "the Kingsway", "The Queensway", "Mimico", "New Toronto", "Long Branch", "Rexdale"],
    delivery: "Delivered across Etobicoke, included, on the standard three to five business days from proof approval. Same-day on 16pt stock if artwork is approved before 11am — we are ten to fifteen minutes away off the 427, so pickup is realistic.",
    faqs: [
      { question: "How fast can I get business cards in Etobicoke?", answer: "Three to five business days from proof approval as standard. If your artwork is approved before 11am and you are on 16pt stock, same-day is possible — and because we are ten to fifteen minutes off the 427, collecting them yourself is often faster than any courier." },
      { question: "Can I see the stock before I order?", answer: "Yes, and from Etobicoke it is worth the trip. Paper is very hard to judge on a screen — 16pt coated, 18pt uncoated and 32pt painted edge feel like three different products in the hand. Twenty minutes with the sample box saves reprinting." },
      { question: "Which stock should a trade business order?", answer: "18pt uncoated, almost always. Trade cards get written on — a quote, a callback time, a part number — and a coated card will not take a pen. Save the soft-touch and spot UV for cards that are handed over rather than worked on." },
    ],
    image: { src: "/local/business-cards-etobicoke.svg", alt: "Business card stocks and finishes for Etobicoke businesses, Surge Labs" },
  },
  {
    service: "signage",
    city: "etobicoke",
    intro: [
      "Signage in Etobicoke is governed by the City of Toronto, not by a local municipality, and that single fact catches out more people here than anything else. Etobicoke has been part of Toronto since 1998, so the sign by-law that applies on The Queensway is the same one that applies on Yonge Street, and it is administered by Toronto Building rather than by anyone in Etobicoke. Anything permanent, illuminated or ground-mounted needs a permit through the City.",
      "The condo corridor along Humber Bay Shores is where that matters most. Ground-floor retail in those towers is usually bound by the building's own signage standard on top of the by-law — a common fascia band, set depths, sometimes a mandated illumination type — and the property manager will have a document that governs it. We will produce to that standard, but we need to see it before we design, not after a fabricated face has been rejected.",
      "The older main streets behave differently. Lake Shore Boulevard through Mimico, New Toronto and Long Branch has the kind of low-rise storefronts where an externally lit fascia and single-colour window vinyl sit far better than an illuminated box, and where a modest sign reads as more confident than a large one. Frosted etch film is the workhorse for clinics and studios along there that want privacy without blanking the window.",
      "Out toward Rexdale and the industrial blocks by the airport it is unit numbers, wayfinding, loading bay identification and coroplast for anything temporary. All 4mm coroplast with H-stakes for the temporary work, printed to 54 inches seamless for anything wide. Straightforward, fast, and rarely a permit question.",
    ],
    neighbourhoods: ["The Queensway", "Humber Bay Shores", "Lake Shore Boulevard", "Mimico", "New Toronto", "Long Branch", "Rexdale"],
    delivery: "Delivered across Etobicoke, included, on two to four business days for large format. Ten to fifteen minutes off the 427 if you would rather collect or have us meet an installer on site.",
    faqs: [
      { question: "Do I need a sign permit in Etobicoke?", answer: "Yes, for anything permanent, illuminated or ground-mounted — and it goes through the City of Toronto, not a local Etobicoke office. Etobicoke has been part of Toronto since 1998, so the Toronto sign by-law applies. Window vinyl within coverage limits generally does not need one." },
      { question: "My unit is in a Humber Bay Shores tower. What do I need to check?", answer: "The building's own signage standard, before anything is designed. Ground-floor retail in those towers usually has a mandated fascia band, set depths and sometimes a required illumination type on top of the city by-law. Ask the property manager for the document and send it to us." },
      { question: "What works on a Lake Shore storefront?", answer: "Restraint. An externally lit fascia sits better on those low-rise buildings than an illuminated box, and single-colour window vinyl sized modestly reads as more established than something large. Frosted etch film is the usual answer where a clinic or studio needs privacy without losing the daylight." },
    ],
    image: { src: "/local/signage-etobicoke.svg", alt: "Storefront and wayfinding signage for Etobicoke businesses, Surge Labs" },
  },
  {
    service: "custom-apparel",
    city: "etobicoke",
    intro: [
      "Etobicoke apparel work is mostly crews and clubs, and the two want opposite things. The trades and contractors working out of Rexdale and the industrial blocks near the airport want hoodies and hi-vis that survive a season, in quantities that make screen printing obviously correct — twenty-four pieces per design is where that process starts, and most crew orders clear it without trying.",
      "The sports and community side is the other half. Etobicoke has a dense club scene, particularly around Long Branch and Alderwood, and those orders are the awkward shape: forty players, forty different numbers, three sizes of parent. That is a DTF job rather than a screen job, because there is no minimum and every piece can be different without adding a setup. One shirt is a real order here, which matters when someone joins in week three.",
      "Along The Queensway and through Mimico the work is hospitality and retail — aprons, polos, caps for staff who are customer-facing and photographed. Those are usually embroidery rather than print, because thread survives commercial laundry in a way that a printed logo does not. We digitise in-house, which means the first order takes a little longer and every reorder after it is quick.",
      "The thing worth knowing before ordering is that garment choice matters more than decoration choice. A cheap blank with a beautiful print is a shirt nobody wears twice, and an unworn shirt advertises nothing. We would rather talk you up a garment tier and down a decoration than the other way round, and for a crew that is outside all winter that is not a preference, it is the difference between kit and landfill.",
    ],
    neighbourhoods: ["Rexdale", "Long Branch", "Alderwood", "The Queensway", "Mimico"],
    delivery: "Delivered across Etobicoke, included, on seven to ten business days from proof approval and garment arrival. Ten to fifteen minutes off the 427 for pickup, and we will hold a size run for a fitting.",
    faqs: [
      { question: "What is the minimum order for custom shirts in Etobicoke?", answer: "For DTF there is no minimum — one piece is a real order, which is what makes it right for club kit where every shirt has a different number. Screen printing starts at twenty-four pieces per design, up to six colours, and is the cheaper choice above that." },
      { question: "Print or embroidery for hospitality staff?", answer: "Embroidery, in almost every case. Aprons, polos and caps in a restaurant or café go through commercial laundry repeatedly, and thread survives that where a printed logo cracks and lifts. We digitise in-house and keep the file, so reorders are fast." },
      { question: "Can you do numbered team kit?", answer: "Yes, and DTF is the right process for it. Every piece can carry a different name and number with no extra setup cost, so a squad of forty is priced the same per shirt as a squad of four. Add a player in week three and it is a one-piece reorder." },
    ],
    image: { src: "/local/custom-apparel-etobicoke.svg", alt: "Screen printed, DTF and embroidered apparel for Etobicoke crews and clubs, Surge Labs" },
  },
  {
    service: "business-cards",
    city: "milton",
    intro: [
      "Milton is the fastest-growing part of our service area and it orders like it. A large share of the business card work here is a first order rather than a reprint — someone who has just registered a company, taken a unit in Derry Green or opened on Main Street, and needs cards before a networking evening on Thursday. That changes the job. A first order needs a conversation about stock, not a price list.",
      "Old Milton along Main Street is the most design-conscious part of the market. The independents there — the practices, the studios, the restaurants around the Farmers' Market end — order 16pt coated with soft-touch, and increasingly foil, because Main Street is a street where people compare businesses on presentation. It is a small enough commercial strip that a good card gets noticed and passed on.",
      "The residential growth areas are the other pattern entirely. Hawthorne Village, Beaty, Clarke, Scott and Dempsey have produced a whole layer of home-run and mobile businesses — trades, tutors, mobile services, real estate — and those want 18pt uncoated in volume, because the card is handed over on a doorstep and frequently written on. A quote, a return date, a callback time.",
      "Then there is Derry Green Corporate Business Park and the industrial spine along James Snow Parkway, which orders the way industrial areas everywhere order: a reliable file, a predictable reprint cycle, no finishes that add cost without adding function. We keep those artwork files set up so a reorder is one email, and we do not put a soft-touch laminate on a card that lives in a truck.",
    ],
    neighbourhoods: ["Old Milton", "Main Street", "Derry Green", "Hawthorne Village", "Beaty", "Clarke", "Scott", "Dempsey", "James Snow Parkway"],
    delivery: "Delivered across Milton, included, on the standard three to five business days from proof approval. We are about thirty minutes west on the 401, so a courier is usually faster than the drive unless you are already coming into Mississauga.",
    faqs: [
      { question: "Do you deliver business cards to Milton?", answer: "Yes, included in the price. We are about thirty minutes west on the 401, and orders arrive within the standard three to five business days from proof approval. Same-day pickup at Skymark Ave is possible on 16pt if artwork is approved before 11am." },
      { question: "I am just starting out. What should I order?", answer: "Fewer than you think, on better stock. A first order of 250 on 16pt coated tells you quickly whether the design works in the hand, and it is cheap to change. Ordering two thousand of a card you have not held is the most common and most expensive first mistake." },
      { question: "What stock suits a mobile or home-run business?", answer: "18pt uncoated. Cards handed over on a doorstep get written on — a quote, a return date — and a coated stock will not take a pen. It is also the stock that ages best in a wallet, which matters when the callback comes three weeks later." },
    ],
    image: { src: "/local/business-cards-milton.svg", alt: "Business card stocks and finishes for Milton businesses, Surge Labs" },
  },
  {
    service: "signage",
    city: "milton",
    intro: [
      "Signage in Milton runs through the Town of Milton, and the Town takes the Main Street heritage character seriously enough that it is worth designing to it rather than around it. Old Milton has a low-rise, older frontage that suits an externally lit fascia and modest window vinyl, and a large internally illuminated box on that street tends to draw exactly the attention nobody wants. Anything permanent, illuminated or ground-mounted needs a permit from the Town.",
      "The growth areas are where the volume is. Hawthorne Village, Beaty and the newer plazas have brought a steady run of unit signage, plaza pylon inserts and window graphics, and those are usually governed by the landlord's sign criteria as much as by the by-law. Plaza pylon slots in particular have a fixed size and frequently a mandated background colour — get the specification from the property manager before anything is designed.",
      "Derry Green Corporate Business Park and the James Snow Parkway industrial spine are straightforward and fast: unit identification, loading bay numbers, wayfinding, safety and directional signage, and coroplast for anything temporary. All of it is 4mm coroplast with H-stakes where it goes in the ground, and anything wide prints to 54 inches seamless so there is no join across a long sign.",
      "The seasonal work here is real and worth planning for. Milton's construction and development pace means a lot of temporary site signage — hoarding graphics, lot markers, open-house directionals — and that work is almost always needed faster than a permanent sign. Coroplast and correx handle it, three to five business days from proof approval, and we will run a repeat set from the same file when the next phase starts.",
    ],
    neighbourhoods: ["Old Milton", "Main Street", "Hawthorne Village", "Beaty", "Derry Green", "James Snow Parkway"],
    delivery: "Delivered across Milton, included, on two to four business days for large format. About thirty minutes west on the 401, and we will produce to an installer's measurements if you would rather we did not attend.",
    faqs: [
      { question: "Do I need a sign permit in Milton?", answer: "For anything permanent, illuminated or ground-mounted, yes — from the Town of Milton. Old Milton's Main Street frontage gets a closer look because of its heritage character. Window vinyl within coverage limits generally does not need a permit." },
      { question: "My unit is in a plaza. What do I need before designing?", answer: "The landlord's sign criteria, and the pylon slot specification if you have one. Plaza pylon inserts usually have a fixed size and often a mandated background colour, and that governs the design as much as the by-law does. Send us the document and we will produce to it." },
      { question: "How fast can I get site or hoarding signage?", answer: "Three to five business days from proof approval on 4mm coroplast, which is the standard for hoarding graphics, lot markers and open-house directionals. We keep the file, so the next phase of a development is a repeat run rather than a new job." },
    ],
    image: { src: "/local/signage-milton.svg", alt: "Storefront, plaza and site signage for Milton businesses, Surge Labs" },
  },
  {
    service: "custom-apparel",
    city: "milton",
    intro: [
      "Milton's apparel work is dominated by two things: youth sport and construction. The town's growth has produced an unusual density of minor sport — hockey, soccer, ball, most of it drawing from the newer residential areas like Hawthorne Village — and those clubs order in the shape that breaks most print shops. Forty players, forty numbers, a size run from youth small to adult XL, and a roster that changes after the first order.",
      "That is a DTF job, not a screen job, and the difference is worth understanding before you get quoted. Screen printing is cheaper per piece above twenty-four but charges setup per colour per design, so forty individually numbered shirts become forty setups. DTF has no minimum and no per-piece setup, so a numbered squad costs the same per shirt whether there are four or four hundred. Adding a player in week three is a one-piece reorder.",
      "The construction and trades side, working out of Derry Green and along James Snow Parkway, is the opposite and screen printing is exactly right for it. One design, one or two colours, forty to a hundred pieces, reordered each season. Hoodies and hi-vis that have to survive a Milton winter outdoors, which means the garment matters more than the decoration.",
      "The retail and hospitality work on Main Street and around Old Milton is smaller and almost always embroidery — aprons, caps, polos for staff who are customer-facing. Thread survives commercial laundry where print does not, and we digitise in-house so the first order sets the file and every reorder after it is fast. Fifteen thread colours in a single design is the ceiling, which is more than any real logo needs.",
    ],
    neighbourhoods: ["Derry Green", "James Snow Parkway", "Main Street", "Old Milton", "Hawthorne Village"],
    delivery: "Delivered across Milton, included, on seven to ten business days from proof approval and garment arrival. About thirty minutes west on the 401, and we will hold a size run for a fitting before a full club order runs.",
    faqs: [
      { question: "What is the best way to print numbered team kit?", answer: "DTF, without question. There is no minimum and no per-piece setup charge, so every shirt can carry a different name and number at the same price. Screen printing charges setup per colour per design, which makes forty individually numbered shirts forty setups." },
      { question: "What is the minimum for screen printed crew hoodies?", answer: "Twenty-four pieces per design, up to six colours. Above that it is the cheaper process per piece and it is what we would recommend for a trades crew ordering the same design each season. Below twenty-four, DTF is the honest answer." },
      { question: "Can we do a fitting before ordering club kit?", answer: "Yes, and for a club order we would rather you did. We hold a size run and you try the actual garment before forty of them are decorated. Youth sizing in particular varies enough between brands that guessing from a chart produces a box of unwearable shirts." },
    ],
    image: { src: "/local/custom-apparel-milton.svg", alt: "DTF, screen printed and embroidered apparel for Milton clubs and crews, Surge Labs" },
  },
];
